...
full outer join fees as f
    on f.psp = 'dlocal' and f.provider_event_id = s.transaction_id
left join {{ ref('int_dlocal_events') }} as e
...
where s.transaction_id is null
    ...
    or f.currency is distinct from 'USD'
    or f.fee_amount is distinct from s.fee_usd
